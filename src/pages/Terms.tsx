          ...
          <div className="terminal-body space-y-6">
            <section>
              ...
              <p className="text-gray-400 leading-relaxed">
                By accessing and using the De Anza Cybersecurity Club (DACC)
              ...
              <ul className="text-gray-400 space-y-2 ml-4">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    ...
                    unsolicited messages, repeatedly submitting forms, or
                    flooding our systems with automated requests.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-hack-red">-</span>
                  <span>
                    <strong className="text-matrix">Illegal Activities:</strong>{" "}
                    Using this website for any unlawful purpose, including but
                    not limited to hacking, unauthorized access attempts, or
                ...
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    ...
                    threatening, or intimidating other users or club members
            ...
            <section>
              ...
              <p className="text-gray-400 leading-relaxed">
                By accessing and using this website, you agree to conduct
                yourself in a respectful and professional manner. We reserve the
            ...
            <section>
              ...
              <p className="text-gray-400 leading-relaxed">
                ...
                DACC is a student-led organization and is not responsible for
                any damages arising from the use of this website.
              </p>
            </section>
